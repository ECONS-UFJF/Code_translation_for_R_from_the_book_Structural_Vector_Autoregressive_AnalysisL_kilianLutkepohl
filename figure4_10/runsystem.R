...
rm(list = ls())
#-------------------------------------------------------------------------------
system.time({# começa contar relogio análise temop de execução tarefa
...
# First period
#monetarysystem('monthlydata.mat','monthlysystem-1967.05-1987.07.RData',TRUE,1967.05,1987.07)
...
}) # finaliza a contagem de tempo execução
